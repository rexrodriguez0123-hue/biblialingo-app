    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSectionHeader('Acerca de BibliaLingo'),
          Card(
            child: Column(
              children: [
                ListTile(
          ...
          Card(
            child: ListTile(
              ...
              onTap: () => _showInfoDialog(
                'Privacidad de Datos',
                'BibliaLingo respeta tu privacidad. Tu progreso de aprendizaje, preferencias teológicas y estadísticas se guardan de forma segura. No compartimos datos con terceros.',
              ),
            ),
          ),
          const SizedBox(height: 30),
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  subtitle: const Text('biblialingo@example.com'),
                  onTap: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Copiar email: biblialingo@example.com'),
